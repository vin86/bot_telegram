...
INSTALL_DIR="/opt/amazon-price-tracker"
...
git clone https://github.com/yourusername/amazon-price-tracker.git $INSTALL_DIR

# Crea e attiva ambiente virtuale
echo -e "\n${BLUE}Configurazione ambiente Python...${NC}"
cd $INSTALL_DIR
python3 -m venv venv
